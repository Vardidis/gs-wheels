                ...
                <Box>  
                    ...
                    {selection === 1 &&    
                        <Box>
                            ...
                            <Stack spacing={6} sx={{ paddingTop: 3, paddingLeft: {lg: 15, md: 15, sm: 10, xs: 5, xxs: 1}, paddingRight: {lg: 15, md: 15, sm: 10, xs: 5, xxs: 1} }}>                                                  
                                <Box sx={{ paddingLeft: {xl: 20, lg: 0, md: 0, sm: 0, xs: 1, xxs: 1}, paddingRight: {xl: 20, lg: 0, md: 0, sm: 0, xs: 1, xxs: 1} }}>
                    ...
                    {selection === 2 &&
                        <Box>
                            ...
                            <Stack spacing={6} sx={{ marginLeft: {xl: 70, lg: 15, md: 5, sm: 5, xs: 3, xxs: 2}, marginRight: {xl: 70, lg: 15, md: 5, sm: 5, xs: 3, xxs: 2}}}>                        
                                <Box sx={{ marginLeft: {xl: 70, lg: 15, md: 5, sm: 5, xs: 3, xxs: 2}, marginRight: {xl: 70, lg: 15, md: 5, sm: 5, xs: 3, xxs: 2}, display: 'flex', justifyContent: 'center', bgcolor: 'rgb(255, 250, 240)', padding: 3, borderRadius: 2, overflow: 'hidden', border: '1px solid rgb(180, 180, 180)' }}>
                                    <Typography sx={{ color: 'rgb(40, 40, 40)' }}>
