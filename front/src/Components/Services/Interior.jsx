    ...
    return(
        <Box sx={{ paddingBottom: 5 }}>            
            <Stack spacing={2}>  
                ...
                <Stack direction='row' spacing={{lg: 2, md: 2, sm: 1, xs: 1, xxs: 1}} sx={{ display: 'flex', justifyContent: 'center', paddingTop: 2, paddingBottom: 3 }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <Link to='/service/life-coaching'>
                        <Button variant="contained" startIcon={<ArrowBackIcon/>} sx={{ width: 200, fontSize: 14 }}>Life Coaching</Button>
                    </Link>                    
                </div>
            </Stack>
        </Box>
