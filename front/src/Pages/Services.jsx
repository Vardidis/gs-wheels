...
const Services = () => {
    return(
        <Box sx={{display: 'flex', justifyContent: 'center', paddingTop: {lg: 5, md: 5}, paddingBottom: 5, backgroundColor: 'theme.light' }}>
            <Stack spacing={3}>
                <Alert severity="success" sx={{ width: {lg: 675, md: 585, sm: '100%', xs: '100%', xxs: '100%'}, fontSize: {lg: 16, md: 16, sm: 14, xs: 12, xxs: 12} }}>
